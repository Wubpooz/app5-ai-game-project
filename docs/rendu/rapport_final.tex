...
Dans le cadre de ce projet, l'objectif principal est de développer une Intelligence Artificielle capable de conduire de façon autonome une partie d'Escampe~\cite{escampe_rules} en temps limité (300s à 900s par joueur). L'agent doit communiquer avec un arbitre validant les coups et garantissant le respect des contraintes temporelles.
...
\]
états distincts. Ce chiffre confirme que toute exploration exhaustive est impossible et que les heuristiques et l'élagage sont indispensables. Contrairement à des jeux entièrement résolus comme le Puissance 4~\cite{connect4_solve}, l'Escampe exige une évaluation heuristique dynamique constante.
...
Le modèle retenu est un \textbf{ResNet dual-perspective avec encodeur CNN spatial}, inspiré du design NNUE~\cite{cp_nnue} (dual-perspective, ClippedReLU, raccourci de sortie direct), des réseaux siamois~\cite{bromley1993} et de la structure résiduelle d'AlphaZero~\cite{alphazero_net}.
...
\bibitem{escampe_rules}
Jeux Stratégie,
\textit{Règles complètes du jeu d'Escampe},
\url{http://jeuxstrategieter.free.fr/Escampe_complet.php}

\bibitem{connect4_solve}
2swap,
\textit{I Solved Connect 4}, vidéo YouTube,
\url{https://youtube.com/watch?v=KaljD3Q3ct0}

\bibitem{monroe_chess_ai}
D. Monroe,
\textit{I Improved the Strongest Chess AI | My Best Idea Yet}, vidéo YouTube,
\url{https://youtube.com/watch?v=geHcAS1fFg8}

\bibitem{alphazero_net}
Chess Programming Wiki,
\textit{AlphaZero Network Architecture},
\url{https://www.chessprogramming.org/AlphaZero#Network_Architecture}

\bibitem{chess_tournament_youtube}
D. Monroe,
\textit{I Ran a Chess Programming Tournament, Here's How it Went!}, vidéo YouTube,
\url{https://youtu.be/Ne40a5LkK6A?si=YQ0QKJNYBpj5fA3l}
