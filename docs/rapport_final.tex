...
Elle furent ensuite téléchargées sur \href{https://huggingface.co/datasets/Bluefir/escampe-dataset}{\textbf{Hugging Face}} pour l'entraînement du modèle BandDPER:  
\begin{figure}[H]
    \centering
...
\begin{itemize}
  ...
  \item \texttt{white\_unicorn} : l'indice de la case occupée par la licorne blanche (de 0 à 35). Logiquement, tends à être plus proche de 0 que de 35.
  \item \texttt{black\_paladins} : un entier long (bitboard) encodant la position des paladins noirs.
  \item \texttt{black\_unicorn} : l'indice de la case occupée par la licorne noire (de 0 à 35). Logiquement, tends à être plus proche de 35 que de 0.
...
Le modèle à tout de même été exporté sur \href{https://huggingface.co/Bluefir/BandDPER}{\textbf{Modèle Hugging Face}}.
