...
Pour régler le problème d'overfitting, j'ai mis à jour le modèle avec un dropout pour régulariser l'entraînement, j'ai augmenté la taille du dataset à 3 million de samples (6 millions en comptant les perspectives inversées).
Cependant, je n'ai pas pu observer le résultat faute de temps d'entraînement suffisant:  
\begin{figure}[H]
    \centering
